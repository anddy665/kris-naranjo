...
use CmsmastersElementor\Modules\TemplateDocuments\Base\Container_Document;
...
class Container extends Container_Document {
	...
	public static function get_properties() {
		...
		$properties = apply_filters( 'cmsmasters_elementor/documents/elementor_container/get_properties', $properties );
	...
	protected function register_controls() {
		...
		/**
		 * Register Elementor Container document controls.
		 *
		 * Used to add new controls to the Elementor container document settings.
		 *
		 ...
		 */
		do_action( 'cmsmasters_elementor/documents/elementor_container/register_controls', $this );
	}
